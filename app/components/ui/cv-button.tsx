...
export const CVButton = ({
  ...
  return (
    <motion.a
      ...
      className="group relative flex items-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-6 sm:py-3 rounded-full bg-black/40 backdrop-blur-md border border-white/10 hover:border-white/30 transition-all duration-300 shadow-2xl"
    >
      {/* Background Glow */}
      ...
      <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#F3E5FC]/70 group-hover:text-white transition-colors duration-300" />
      <span className="text-[#F3E5FC]/80 font-zendots text-xs sm:text-base tracking-wider group-hover:text-white transition-colors duration-300">
        Download my CV
      </span>

...
interface InteractiveShaderProps {
  ...
  brightness?: number;       // Overall brightness multiplier (0-1)
  className?: string;
}
...
const InteractiveShader: React.FC<InteractiveShaderProps> = ({
  ...
  useEffect(() => {
    ...
    // Container-relative resize helper
    ...
    const fragmentShaderSrc = `
      ...
      void main() {
        ...
        vec3 baseColor = vec3(0.6, 0.3, 0.9);
        baseColor *= 1.0 - smoothstep(0.01, 0.02, pattern);
        baseColor += pow(1.0 - b.x, 10.0) * 0.08;
  ...
  }, [cellDensity, animationSpeed, warpFactor, mouseInfluence, brightness]);

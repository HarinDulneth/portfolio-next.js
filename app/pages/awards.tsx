    ...
    <section className="h-[100vh] py-20 md:py-40">
      <div className="mx-auto max-w-7xl space-y-8 px-6 md:space-y-16">
        <div className="relative z-10 mx-auto max-w-4xl space-y-5 text-center md:space-y-10">
          <div ref={headingRef}>
            <MatrixText
              text="Awards and Winnings"
              className="text-4xl font-medium lg:text-5xl font-orbitron"
              trigger={isInView}
            />
          </div>
          <TextShimmer
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-rows-2">
          <div className="gradient-card p-[2px] sm:col-span-2 lg:row-span-2 group">
            <Card
              className="grid grid-rows-[auto_1fr] gap-3 sm:p-6 h-full"
              style={{
                background:
            ...
            >
              <CardHeader>
                <h3 className="text-xl font-medium text-white/85">
                  🏆 Champions - Kelani Xtreme
                </h3>
              </CardHeader>
              <CardContent>
                <blockquote className="grid h-full grid-rows-[auto_1fr_auto] gap-6">
                  <img
                    className="w-full rounded-xl object-cover max-h-64 transition-transform duration-300 group-hover:scale-105 cursor-pointer"
                  ...
                  <p className="text-md font-medium text-white/85">
                    ...
                    brainstorming, coding, and rapid problem-solving under
                    pressure.
                  </p>
                  ...
                  <div className="grid grid-cols-[auto_1fr] items-center gap-3">
                    ...
                    <div>
                      <cite className="text-sm font-medium text-gray-400">
                        IEEE Student Branch of University of Kelaniya
                      </cite>
                      <a
          ...
          <div className="gradient-card p-[2px] md:col-span-2 group">
            <Card
              ...
              style={{
                background:
                  "radial-gradient(120% 120% at 70% 10%, #1a1a1a 0%, #0f0f10 60%, #0b0b0c 100%)",
              }}
            >
          ...
          <div className="gradient-card p-[2px]">
            <Card
              ...
              style={{
                background:
                  "radial-gradient(120% 120% at 50% 50%, #1a1a1a 0%, #0f0f10 60%, #0b0b0c 100%)",
              }}
            >
              <CardContent className="h-full pt-6">
                <blockquote className="grid h-full grid-rows-[auto_1fr_auto] gap-4">
